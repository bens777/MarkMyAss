...
piece of text and want to know what MarkMyAss can genuinely check for
it — and what a "not found" result does and doesn't prove — read this
before you trust any tool's answer, including MarkMyAss's.
...
- "This text is definitely human-written." MarkMyAss checks for specific
...
- "No AI provider anywhere embeds anything undetected by MarkMyAss."
  MarkMyAss only implements the specific mechanisms listed above.

## What MarkMyAss does NOT prove

The single most important limitation: **MarkMyAss cannot tell you
...
writing — MarkMyAss included. What you *can* check: whether it contains
...
human-written?**
No. MarkMyAss reports what its named detectors found or didn't find —
