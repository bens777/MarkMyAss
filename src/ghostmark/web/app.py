...
LAB_PAGE_META: dict[str, PageMeta] = {
    "": PageMeta(
        title="MarkMyAss AI Watermark Lab — Proof, Not Promises",
        description=(
            "A living, honest technical reference for AI watermark and provenance signals: "
            "what MarkMyAss can detect, remove, and independently verify -- and what it can't."
        ),
        path="/lab",
        breadcrumbs=(("Home", "/"), ("AI Watermark Lab", "/lab")),
    ),
    "claude-watermark": PageMeta(
        title='Lab: "Claude Watermark" — Metadata vs. Hidden Unicode vs. Statistical Watermarking | MarkMyAss',
        description=(
    ...
    "c2pa": PageMeta(
        title="Lab: C2PA / Content Credentials — Detection, Removal, Limits | MarkMyAss",
        description="What MarkMyAss's C2PA support actually does: JUMBF container detection, "
    ...
    "hidden-unicode": PageMeta(
        title="Lab: Hidden Unicode — Detection & Removal Methodology | MarkMyAss",
        description="How MarkMyAss detects and safely removes hidden/invisible Unicode "
    ...
    "pdf-metadata": PageMeta(
        title="Lab: PDF Metadata — DocInfo & XMP Detection and Removal | MarkMyAss",
        description="How MarkMyAss detects and removes PDF DocInfo and XMP metadata, "
...
BENCHMARKS_PAGE_META = PageMeta(
    title="MarkMyAss Benchmarks — Real Results From the Public Test Corpus",
    description="Detection, cleaning, and independent-verification pass rates generated by "
    "actually running MarkMyAss's reproducible test corpus -- not hand-typed numbers.",
    path="/benchmarks",
...
SEO_PAGE_META: dict[str, PageMeta] = {
    "claude-watermark-remover": PageMeta(
        title="Claude Watermark Remover — Inspect, Clean & Verify | MarkMyAss",
        description=(
    ...
    "claude-watermark-detector": PageMeta(
        title="Claude Watermark Detector — What MarkMyAss Can Actually Check | MarkMyAss",
        description=(
    ...
    "ai-watermark-remover": PageMeta(
        title="AI Watermark Remover — Every Mechanism, Explained Separately | MarkMyAss",
        description=(
            "AI watermark means at least five different mechanisms. See MarkMyAss's real support "
    ...
    "ai-metadata-cleaner": PageMeta(
        title="AI Metadata Cleaner — PDF, JPEG, PNG, WebP | MarkMyAss",
        description=(
    ...
    "c2pa-remover": PageMeta(
        title="C2PA Remover — Detection, Removal & Limitations | MarkMyAss",
        description=(
            "What MarkMyAss actually sees and removes in a C2PA manifest's JUMBF container -- "
    ...
    "content-credentials-remover": PageMeta(
        title="Content Credentials Remover — The 'cr' Icon, Explained | MarkMyAss",
        description=(
            "What the Content Credentials icon means, how it relates to C2PA, and what MarkMyAss "
    ...
    "hidden-unicode-remover": PageMeta(
        title="Hidden Unicode Remover — Strip Invisible Characters From Text | MarkMyAss",
        description=(
