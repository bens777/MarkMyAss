...
maintainers via a GitHub issue marked confidential, or via GitHub's private
vulnerability/report tooling if the behavior also involves a security
concern. Maintainers will review and investigate all complaints and will
respond in a way deemed appropriate to the circumstances.
