"""The /run-local developer guide: route availability, rendering, and content integrity."""
...
def test_seo_metadata_present(client):
    ...
    assert "https://moseisley.sh/ghostmark/run-local" in html  # canonical resolves under base_path
...
def test_home_page_links_to_run_local(client):
